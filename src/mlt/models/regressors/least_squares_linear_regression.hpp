...
namespace regressors {
    ...
    public:         
        ...
        LeastSquaresLinearRegression& fit(const Eigen::MatrixXd& input, const Eigen::MatrixXd& result) {
            ...
            Eigen::MatrixXd coeffs = utils::linalg::pseudo_inverse(input_prime.transpose() * input_prime) * input_prime.transpose() * result;
